...
export const projects: Project[] = [
    ...
    },
    {
        name: 'GoNuxt',
        description: {
            de: "Un boilerplate en Nuxt.js pour démarrer rapidement n'importe quel SaaS ou micro-SaaS. Il est livré avec des fonctionnalités telles que l'authentification, les paiements Stripe, les e-mails, les pages de profil, et bien plus encore. Il est conçu pour être facilement extensible et personnalisable. Pas besoin de réfléchir à la mise en place de votre application, GoNuxt le fait pour vous !",
    ...
    },
    {
        ...
        description: {
            ...
            de: "Une application web pour aider les utilisateurs à apprendre les drapeaux et les capitales des pays, offrant une expérience d'apprentissage ciblée basée sur les régions. Construit en utilisant Vue.js et Tailwind CSS, avec des services backend hébergés via Docker et Nginx."
        },
    ...
    },
    {
        ...
        description: {
            ...
            de: "Mon site web de portfolio personnel, présentant mes projets, compétences, expérience professionnelle, et plus encore ! Ce projet a été développé en utilisant Nuxt.js, TailWind CSS, et TypeScript, en mettant l'accent sur le design responsive et l'accessibilité. Le design est très propre, minimaliste, et moderne."
        },
        type: ['web', 'favorite'],
        date: '2024',
    ...
    },
    {
        ...
        description: {
            ...
            de: "Un package Python servant de wrapper API pour l'univers One Piece, permettant aux utilisateurs de récupérer des données de la série. Ce projet a été une expérience d'apprentissage dans le développement de packages Python et l'intégration d'API"
        },
    ...
    },
    {
        ...
        description: {
            ...
            de: 'Un site web de portfolio créé pour Levi Lea, une étudiante en design graphique. Le site présente son travail et a été développé en utilisant Vue.js, TypeScript et Tailwind CSS.'
        },
        type: ['web'],
        date: '2023',
    ...
    },
    {
        ...
        description: {
            ...
            de: "Inspiré du classique puzzle de la Tour de Hanoï, ce jeu met au défi les joueurs de déplacer des disques entre des tours en utilisant TypeScript et Three.js. J'ai commencé avec JavaScript et suis passé à TypeScript, apprenant à utiliser Three.js pour les graphiques 3D."
        },
        type: ['game'],
        date: '2022',
    ...
    },
    {
        ...
        description: {
            ...
            de: "Un jeu de mémoire inspiré de l'univers de l'anime One Piece, permettant un jeu solo ou multijoueur avec différents niveaux de difficulté. Ce projet a été l'occasion de pratiquer TypeScript et d'explorer le thème de One Piece."
        },
        type: ['web', 'game'],
        date: '2022',
    ...
    },
    {
        ...
        description: {
            ...
            de: "Ce projet est un bot Twitter qui tweete quotidiennement des statistiques sur la plateforme Steam, y compris les jeux tendances, les jeux les plus joués et les pics de joueurs. Hébergé sur un serveur TrueNAS avec Docker, j'ai développé ce bot en utilisant Tweepy pour partager des données de jeu et j'ai pratiqué la conteneurisation pour l'hébergement local."
        },
        type: ['scripting'],
        date: '2022',
    ...
    },
    {
        ...
        description: {
            ...
            de: "Cette application Python aide les utilisateurs à suivre leurs temps de résolution de Rubik's Cube sur différents types de cubes. Elle stocke les données de session localement, fournissant des mises à jour automatiques et des statistiques détaillées pour surveiller les progrès au fil du temps."
        },
        type: ['game'],
        date: '2022',
        technos: ['Python', 'Pygame'],
    ...
    },
    {
        ...
        description: {
            ...
            de: 'Une version numérique du jeu classique Puissance 4, permettant aux joueurs de concourir contre une IA ou un autre joueur. Le jeu a été développé en utilisant Python et Pygame.'
        },
        type: ['game'],
        date: '2022',
        technos: ['Python', 'Pygame'],
    ...
    },
    {
        ...
        description: {
            ...
            de: "Un jeu sérieux inspiré de Pac-Man, développé lors de l'événement 'La Nuit de l'Info' pour sensibiliser à propos du SIDA. Le jeu comprend des éléments éducatifs sur le virus, construit en utilisant HTML, CSS et JavaScript."
        },
        type: ['web', 'game'],
        date: '2022',
